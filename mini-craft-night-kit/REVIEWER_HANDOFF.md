...
K6_PHASE_D_PRIVATE_RUNTIME_DEPLOYMENT_AND_RESTORE=RETURN_IMAGE_ACQUISITION_AUTHORIZATION_REQUIRED
K6_PHASE_D_R1_IMAGE_ACQUISITION_SEAL_AND_PRIVATE_DEPLOYMENT_RESUME=RETURN_COMPOSE_SOURCE_HASH_MISMATCH
COMPOSE_SOT_RECONCILIATION=PASS_CANONICAL_C52_ACCEPTED
K6_PHASE_D_R2_COMPOSE_SOT_RECONCILIATION_AND_PRIVATE_RESTORE=RETURN_MARIADB_RESTORE_INCOMPLETE
POST_RETURN_EXECUTION_DEVIATION=RECORDED_NON_COMPROMISING
K6_PHASE_D_R3_DB_RESTORE_DIAGNOSIS_AND_CONDITIONAL_RETRY=RETURN_SCHEMA_OR_DUMP_DRIFT
K6_PHASE_D_R4_DETERMINISTIC_FILTERED_IMPORT_RETRY=RETURN_WORDPRESS_CORE_FILES_MISSING
MARIADB_RESTORE_STATE=PASS_52_TABLES
K6_PHASE_D_R5_WORDPRESS_CORE_RUNTIME_DIAGNOSIS_AND_CONDITIONAL_RECREATE=RETURN_RUNTIME_CORE_PRESENT_RECONCILIATION_REQUIRED
K6_PHASE_D_R6_BOOTSTRAP_RECONCILIATION_AND_PRIVATE_APP_VALIDATION=RETURN_SSH_CONNECTION_REQUIRED
K6_PHASE_D_R6R1_SSH_TRANSPORT_RECOVERY_AND_BOOTSTRAP_RESUME=RETURN_REMOTE_IDENTITY_PROBE_INVALID
...
K6_PHASE_E_SERIALIZED_SAFE_URL_MIGRATION=RETURN_MIGRATION_HELPER_INITIALIZATION_FAILED
WPCLI_EXACT_IMAGE_IDENTITY=PASS
PHASE_E_DB_MUTATION_REACHED=NO
...
K6_PHASE_F_R1_SHARED_INGRESS_CONFIG_SOURCE_RECONCILIATION=RETURN_READONLY_EXECUTION_HELPER_ERROR
...
MARIADB_RESTORE_STATE=PASS_52_TABLES
WORDPRESS_RUNTIME_STATE=RUNNING_PRIVATE_RUNTIME_PASS_SERIALIZED_MIGRATION_PASS
PAYPAL_LIVE=NO
REAL_PAYMENT=NO
