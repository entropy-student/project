...
- The shared root itself had no Mini Craft document directly under it. Nine loose docs in two root-level historical Mini Craft folders were moved into the workspace archive; the sole direct root document is an unrelated shared handoff, left untouched.
